...
export default function FeatureCard({ icon, title, description, delay = '0ms' }: FeatureCardProps) {
  return (
    <div
      className="bg-white rounded-2xl p-5 shadow-sm border border-primary/10 hover:shadow-md hover:border-primary/30 transition-all duration-300 animate-slide-in motion-reduce:animate-none motion-reduce:transition-none"
